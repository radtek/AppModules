...
namespace HtmlRenderer.Utils
{
    ...
    internal sealed class ImageLoadHandler : IDisposable
    {
        ...
        /// <summary>
        /// Load the image file on threadpool thread and calling <see cref="ImageLoadComplete"/> after.
        /// </summary>
        ...
        /// <summary>
        /// Load the image file on threadpool thread and calling <see cref="ImageLoadComplete"/> after.<br/>
        /// Calling <see cref="ImageLoadComplete"/> on the main thread and not threadpool.
        /// </summary>
        /// <param name="source">the file path to get the image from</param>
        private void SetImageFromFileAsync(object source)
        {
            try
            {
                ...
                {
                    // stream will be closed by the image object
                    var stream = File.Open(((FileInfo) source).FullName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
