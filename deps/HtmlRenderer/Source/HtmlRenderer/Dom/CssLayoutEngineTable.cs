...
namespace HtmlRenderer.Dom
{
    ...
    internal sealed class CssLayoutEngineTable
    {
        ...
        /// <param name="g"></param>
        /// <param name="tableBox"> </param>
        public static void PerformLayout(Graphics g, CssBox tableBox)
        {
        ...
        private void DetermineMissingColumnWidths(Graphics g, float availCellSpace)
        {
        ...
        private void EnforceMaximumSize(Graphics g)
        {
            int curCol = 0;
        ...
        private void GetColumnsMinMaxWidthByContent(Graphics g, bool onlyNans, out float[] minFullWidths, out float[] maxFullWidths)
        {
